...
const Register = () => {
	...
	const getFIDs = async () => {
		var fids = await axios.get(
			`https://leavesysbit.pythonanywhere.com/api/getFIDs`
		);
	...
	const submitHandler = async (e) => {
		...
		console.log(fd);
		await axios
			.post(`https://leavesysbit.pythonanywhere.com/api/upload/${FID}`, fd)
			.then((res) => {
		...
		var response = await axios
			.post("https://leavesysbit.pythonanywhere.com/api/register", {
				type: type,
				name: name,
				fid: FID,
